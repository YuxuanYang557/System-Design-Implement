 ...
 * @author yangyuxuan
 */
public class ViewStreamerDetails extends javax.swing.JPanel {

    /**
     * Creates new form ViewStreamerDetails
     */
    ...
    public ViewStreamerDetails(JPanel rightPanel, DB4OUtil db4o, User user, Enterprise enterprise,Advertisement ad,EcoSystem ecosystem ) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ad.setStatus("Work complete");
        db4o.storeSystem(ecosystem);
        JOptionPane.showMessageDialog(null,"Approvel successfully");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        if(!ad.getStatus().equals("Work complete")){
        ad.setStatus("Waiting for apply");
        db4o.storeSystem(ecosystem);
        JOptionPane.showMessageDialog(null,"You rejected this apply");
        }else{
         JOptionPane.showMessageDialog(null,"The process is already complete");
    }
